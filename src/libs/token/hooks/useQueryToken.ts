...
export const useQueryTokensHot = (options?: UseQueryOptions<Token[], Error, Token[]>) => {
...
export const useQueryToken = (address: string, options?: UseQueryOptions<Token, Error, Token>) => {
	return useQuery<Token, Error, Token>({
