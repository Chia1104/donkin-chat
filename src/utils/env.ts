...
export const env = createEnv({
	...
	client: {
		...
		NEXT_PUBLIC_APP_NODE_ENDPOINT: z.string().min(1),
	...
	runtimeEnv: {
		...
		NEXT_PUBLIC_AI_SERVICE_ENDPOINT: process.env.NEXT_PUBLIC_AI_SERVICE_ENDPOINT,
		NEXT_PUBLIC_PUBLIC_SERVICE_ENDPOINT: process.env.NEXT_PUBLIC_PUBLIC_SERVICE_ENDPOINT,
