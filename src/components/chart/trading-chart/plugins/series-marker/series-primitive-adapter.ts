import type { ISeriesApi, ISeriesPrimitive, DeepPartial, SeriesType } from 'lightweight-charts';
...
export class SeriesPrimitiveAdapter<
	T,
	Options = unknown,
	IPrimitive extends ISeriesPrimitiveWithOptions<T, Options> = ISeriesPrimitiveWithOptions<T, Options>,
